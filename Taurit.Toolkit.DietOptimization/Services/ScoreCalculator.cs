...
namespace Taurit.Toolkit.DietOptimization.Services
{
    ...
    public class ScoreCalculator
    {
        ...
        public Double CalculateScore(DietCharacteristics diet, DietTarget target)
        {
            ...
            score += PunishForDiffAbove(diet.TotalPrice, target.MaxPrice, 20.0);
        ...
        {
            const Int32 preferredMaxIngredientCount = 23; // I currently have 20 products on typical grocery shopping list
